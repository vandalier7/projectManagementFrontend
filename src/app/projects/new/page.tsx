...
export default function NewProjectPage() {
	...
	return (
		<main className="min-h-screen bg-bg flex items-center justify-center">
			<div className="bg-surface border border-border rounded-xl shadow-md px-10 py-12 w-full max-w-lg flex flex-col gap-8">
				<h1 className="text-2xl font-semibold text-text m-0">New Project</h1>
				...
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col gap-1.5">
						<label className="text-xs text-muted uppercase tracking-wide">Lead</label>
						<select
